    ...
    <div className="h-screen flex flex-col bg-gray-100">
      ...
      <div className="bg-white border-b px-4 py-2 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          {!isRunning && (
            <div className="relative flex items-stretch rounded border border-gray-300">
              <button
                onClick={() => {
                  setStartMode('beginning');
                  navigatedBeatIdRef.current = null;
                ...
                className={`px-3 py-1.5 text-sm flex items-center gap-1.5 rounded-l ${
                  startMode === 'beginning'
              ...
              <button
                ...
                className={`px-1.5 border-l border-gray-300 rounded-r ${
          ...
          {!isRunning && startBeatId && startBeatId !== story.getMetadata().firstBeatId && (
            <div className="relative">
              ...
              {showPresetMenu && (
                <div className="absolute left-0 top-full mt-1 w-96 max-h-[28rem] overflow-y-auto bg-white border border-gray-200 rounded-lg shadow-lg z-[100]">
                  {/* Header */}
