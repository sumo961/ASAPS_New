    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {/* Local LLM Warning */}
          {isConfigured && currentProvider === 'local' && (
            <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <Info className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-amber-900">Local LLM Detected</p>
                <p className="text-sm text-amber-700 mt-1">
                  Local models typically lack the context window and reasoning ability needed for
                  complex story generation. Results may be incomplete or malformed. For best results,
