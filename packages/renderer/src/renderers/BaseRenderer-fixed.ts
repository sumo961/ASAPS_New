...
import type { Transition, Sound } from '@asaps/core';
...
export abstract class BaseRenderer implements IRenderer {
  ...
  abstract renderTitleScreen(title: string, author: string, buttonText: string): Promise<void>;
  abstract renderText(text: string, buttonText: string): Promise<void>;
  abstract renderDurScreen(text: string, duration: number): Promise<void>;
