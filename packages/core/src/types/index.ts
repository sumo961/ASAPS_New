...
export interface StatePreset {
  ...
  state: {
    ...
    /** The characters' feelings at this point (StoryContext affect
     *  snapshot) — so a preview started mid-story has them, and feelings
     *  conditions evaluate as they would in play. */
