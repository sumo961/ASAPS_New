...
export const AssetSelectionModal: React.FC<AssetSelectionModalProps> = ({
  ...
  const filteredAssets = assets.filter(asset => {
    ...
    // Enhanced subtype filtering based on file extensions and categories
    if (assetSubType) {
      if (assetSubType === 'background') {
        // Backgrounds are typically JPG/JPEG images
        const isBackground = asset.type === 'image' && 
          (asset.url.toLowerCase().endsWith('.jpg') || 
           asset.url.toLowerCase().endsWith('.jpeg') ||
           asset.subType === 'background');
        if (!isBackground) return false;
      } else if (assetSubType === 'character') {
        // Characters are typically PNG images with transparency
        ...
        // Props are also typically PNG images
      ...
      } else if (asset.subType !== assetSubType && asset.subType !== assetSubType) {
        return false;
      }
    }
