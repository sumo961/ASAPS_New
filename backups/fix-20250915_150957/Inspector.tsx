          ...
          {(!supportsVisualEditor(beat.type) || activeTab === 'properties') && (
            <div className="h-full overflow-y-auto p-4">
              <div className="space-y-4">
                ...
                {/* BEAT-SPECIFIC PARAMETERS - RESTORED */}
                ...
                {beat.type === 'durScreen' && (
                  <>
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        value={localBeat.parameters?.duration || 3}
                ...
                {beat.type === 'endScreen' && (
                  <>
                    ...
                    <div>
                      ...
                      <select
                        value={localBeat.parameters?.reset || 'true'}
                        onChange={(e) => handleParameterChange('reset', e.target.value)}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                      >
                        <option value="true">Yes - Reset all progress</option>
                        <option value="false">No - Keep progress</option>
                      </select>
                    </div>
                  </>
                )}
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                        placeholder="Variable/counter name"
                      />
                    </div>
