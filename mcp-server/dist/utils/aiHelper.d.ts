...
export declare const BEAT_TYPES: {
    ...
    readonly infoText: "Narrative text with Continue button. SINGLE CONNECTION ONLY: can only connect to ONE target! ❌ WRONG: infoText with 2+ connections. ✓ For branching, use multiChoice (or dialogTree for multi-turn dialogue, movementChoice for spatial hotspots). Optional: textVariations (array) for random text selection at runtime.";
