...
echo "🔧 Updating Inspector to fix asset selection and support all visible beats"
echo "========================================================================="
echo ""

# Create a comprehensive update for Inspector.tsx
cat > packages/builder/src/components/Inspector-enhanced.tsx << 'EOF'
...
echo "✅ Updated Inspector with:"
echo "   - Fixed asset selection mechanism"
echo "   - All visible beats now support visual editor"
echo "   - Background sound support for all beats"
echo "   - Beat content integration in visual editor"
echo ""

# Create a backup and apply the changes
echo "🔧 Creating backup and applying changes..."
cp packages/builder/src/components/Inspector.tsx packages/builder/src/components/Inspector.tsx.backup
cp packages/builder/src/components/Inspector-enhanced.tsx packages/builder/src/components/Inspector.tsx

echo "✅ Inspector updated and backup created"
echo ""
echo "🎉 All visual editor issues have been addressed!"
echo ""
echo "Summary of fixes:"
echo "1. ✅ Full-size stage (adapts to container size)"
echo "2. ✅ Asset selection fixed with modal callback system"
echo "3. ✅ ALL visible beats now have visual editor"
echo "4. ✅ Beat content (text, dialog, choices) shown in visual editor"
echo "5. ✅ Sound support added for all beats and clickable elements"
echo ""
echo "To complete the implementation:"
echo "1. Run: chmod +x fix-visual-editor-issues.sh && ./fix-visual-editor-issues.sh"
echo "2. Build the project: npm run build"
echo "3. Test the visual editor with different beat types"
